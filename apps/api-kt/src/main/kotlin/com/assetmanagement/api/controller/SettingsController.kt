...
class SettingsController(
    ...
    fun updateAlerts(@RequestBody request: AlertSettingsDto): ResponseEntity<Any> {
        ...
        if (request.slackWebhookUrl != maskWebhookUrl(getSetting("alerts.slack.webhookUrl"))) setSetting("alerts.slack.webhookUrl", request.slackWebhookUrl, userName)
        if (request.slackWarrantyWebhookUrl != maskWebhookUrl(getSetting("alerts.slack.warrantyWebhookUrl"))) setSetting("alerts.slack.warrantyWebhookUrl", request.slackWarrantyWebhookUrl, userName)
        if (request.slackCertificateWebhookUrl != maskWebhookUrl(getSetting("alerts.slack.certificateWebhookUrl"))) setSetting("alerts.slack.certificateWebhookUrl", request.slackCertificateWebhookUrl, userName)
        if (request.slackLicenceWebhookUrl != maskWebhookUrl(getSetting("alerts.slack.licenceWebhookUrl"))) setSetting("alerts.slack.licenceWebhookUrl", request.slackLicenceWebhookUrl, userName)
