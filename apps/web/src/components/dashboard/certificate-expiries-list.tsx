...
import type { CertificateExpiryItem } from "@/types/dashboard";

interface CertificateExpiriesListProps {
  data: CertificateExpiryItem[] | undefined;
  isLoading: boolean;
  days: number;
...
export function CertificateExpiriesList({
  data,
  isLoading,
  days,
  onDaysChange,
}: CertificateExpiriesListProps) {
  return (
